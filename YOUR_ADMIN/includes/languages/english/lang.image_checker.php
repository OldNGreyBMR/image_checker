...
// English
$define = [
    'HEADING_TITLE' => 'Images Checker',
    'TEXT_VERSION' => 'version ',
    'TEXT_IMAGES_DIRECTORY' =>'Images path: '. 'DIR_FS_CATALOG_IMAGES',
    
    'TEXT_LIST_TYPE' => 'Check:',
    'TEXT_CHECK_CATEGORIES' => 'Categories',
    'TEXT_CHECK_PRODUCTS' => 'Products',
    'TEXT_FILTERS' => 'Filters:',
    'TEXT_LIST_ALL' => 'List all:',
    'TEXT_LIST_DISABLED' => 'List disabled:',
    'TEXT_LIST_NO_IMAGES' => 'List entries with no images defined:',
    'TEXT_ENTRIES_CHECKED' => 'Entries checked: ',
    'TEXT_IMAGE_PROBLEMS' => 'Image problems: ',
    'TEXT_QUERY_LIMITED' => 'Results limited to <b>%s</b> entries.</b>',
    
    'TEXT_NO_ERRORS_FOUND' => '<p>There were no image errors found.<br />All entries with images defined refer to a valid image file, with the correct extension and of a common web image format.</p>',
