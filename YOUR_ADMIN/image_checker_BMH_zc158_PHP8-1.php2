...
//
// BMH 2019 change edit link from categories to product line 529; line 534
// BMH 2022-12-25 vars
//                  ln533 undefined index 1
                ...
                <tr class="dataTableRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)">
                    ...
                    <td class="center" style="padding-left: 0">
                        <?php if ($list_categories) {
                            //echo '<br> image_checker.php ln527 ' . 'zen_get_path($value[\'id\']) ='.zen_get_path($value['id']).'<br />';
							...
							// BMH $parent_cPath = $categories_path_array[0][1]['id'];
                            $parent_cPath = isset($categories_path_array[0][1]['id']) ?? NULL;  // BMH DEBUG Undefined array key 1
                            //echo '$parent_cPath='.$parent_cPath.'<br />';
// BMH alter second link to find product not categories
